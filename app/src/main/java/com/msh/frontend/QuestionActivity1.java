...
public class QuestionActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textInputLayout= findViewById(R.id.response);
        ...
        myRef.child("Question").child(set).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(list.size()>0){
                    ...
                    nextBtn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            if( position == list.size()){
                                ...
                                Toast.makeText(QuestionActivity1.this,user,Toast.LENGTH_SHORT).show();
                                reference = FirebaseDatabase.getInstance().getReference("Response");
                                reference.child(user).child(set).setValue(total);
                                Intent intent= new Intent(QuestionActivity1.this,Result.class);
                    ...
                    finish();
                    Toast.makeText(QuestionActivity1.this,"no question left",Toast.LENGTH_SHORT).show();
                }
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(QuestionActivity1.this,error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
